...
public class DashboardController {
	...
	public String addTask(@PathVariable("userStoryID") int id) {
		return "addtask";
	}

	@RequestMapping(value = "/addtask/{scrumMasterID}/{userStoryID}", method = RequestMethod.POST)
	public String addTask(@ModelAttribute("task") Task task, @PathVariable("scrumMasterID") int scrumMasterID, @PathVariable("userStoryID") int userStoryID, Model model) {
